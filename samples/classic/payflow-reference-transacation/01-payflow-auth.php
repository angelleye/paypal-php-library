...
$PayPalRequestData = array(
		...
		'trxtype'=>'A', 				// Required.  Indicates the type of transaction to perform.  Values are:  A = Authorization, B = Balance Inquiry, C = Credit, D = Delayed Capture, F = Voice Authorization, I = Inquiry, L = Data Upload, N = Duplicate Transaction, S = Sale, V = Void
		'acct'=>'4012888888881881', 				// Required for credit card transaction.  Credit card or purchase card number.
		'expdate'=>'1223', 				// Required for credit card transaction.  Expiration date of the credit card.  Format:  MMYY
		'amt'=>'0.00', 					// Required.  Amount of the transaction.  Must have 2 decimal places.
		'dutyamt'=>'', 				//
		'freightamt'=>'', 			//
		'taxamt'=>'', 				//
		'taxexempt'=>'', 			// 
		...
		'shiptocountry'=>'', 		// Ship to country code.
