...
$order_data = [
    'intent' => 'AUTHORIZE', // [CAPTURE, AUTHORIZE] - Indicates if the payment is for immediate capture or authorization.
    'purchase_units' => [
        [
            ...
            'amount' => [
                'currency_code' => 'USD', // [Required] 3-character currency code (e.g., 'USD').
                'value' => '100.00', // [Required] Total value of the transaction.
                'breakdown' => [
                    'item_total' => [
    ...
    'application_context' => [
        'return_url' => $domain . 'samples/get-order-details.php', // [Required] URL for redirection after approval.
        'cancel_url' => $domain . 'samples/create-order.php', // [Required] URL for redirection after cancellation.
