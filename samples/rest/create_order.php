...
try {
    ...
    $purchase_unit = [
        ...
        'amount' => [
            'currency_code' => 'USD',            // string [3] - The currency code for the payment.
            'value' => '100.00',                    // string [1..32] - The total amount value.
            'breakdown' => [
                'item_total' => [             // Total item amount.
                    'currency_code' => 'USD',    // string [3] - Currency code for items.
                    'value' => '80.00'             // string [1..32] - Value of item total.
                ],
                'shipping' => [               // Shipping fee.
                    'currency_code' => 'USD',    // string [3] - Currency code for shipping.
                    'value' => '10.00'             // string [1..32] - Value of shipping.
                ],
                'handling' => [               // Handling fee.
                    'currency_code' => 'USD',    // string [3] - Currency code for handling.
                    'value' => '5.00'             // string [1..32] - Value of handling.
                ],
                'tax_total' => [              // Total tax amount.
                    'currency_code' => 'USD',    // string [3] - Currency code for tax.
                    'value' => '5.00'             // string [1..32] - Value of total taxes.
                ],
        ...
        'items' => [
            [
                'name' => 'Widget',                  // required - string [1..127] - The item name or title.
                'quantity' => '2',              // required - string [<=10] - The item quantity.
                'description' => 'This is the best widget ever!',           // string [<=127] - Detailed item description.
                'sku' => 'ABC-123',                   // string [<=127] - Stock keeping unit (SKU) for the item.
                ...
                'unit_amount' => [             // required - The item price or rate per unit.
                    'currency_code' => 'USD',     // string [3] - Currency code for unit amount.
                    'value' => '40.00'              // string [1..32] - Value of the unit amount.
                ],
