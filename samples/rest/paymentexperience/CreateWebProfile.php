...
$WebProfile = array(
    'Name'                => "IPS! T-Shirt Shop" . uniqid(),                                             // The web experience profile name. Unique for a specified merchant's profiles.
