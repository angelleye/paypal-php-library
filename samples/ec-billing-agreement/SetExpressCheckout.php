...
$SECFields = array(
					...
					'returnurl' => $domain . 'samples/ec-billing-agreement/GetExpressCheckoutDetails.php', 							// Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
					'cancelurl' => $domain . 'samples/ec-billing-agreement/', 							// Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
...
$Payment = array(
    ...
    'desc' => 'Billing Agreement Setup', 							// Description of items on the order.  127 char max.
