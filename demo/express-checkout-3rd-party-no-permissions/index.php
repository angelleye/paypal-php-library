...
/**
 * When using Express Checkout to send payments to 3rd party merchants
 * you will use your own API credentials in the config file, and
 * simply pass the email address or PayPal account ID of the account
 * you want the money to go to in the API requests.
 *
 * Here we are setting a simple, static session value that we'll use
 * to populate our SetExpressCheckout and DoExpressCheckoutPayment
 * calls later in the checkout flow.
 */
$_SESSION["seller"] = "paypal-facilitator@angelleye.com";
...
<head>
<meta charset="utf-8">
<title>PayPal Express Checkout - 3rd Party No Permissions Demo | PHP Class Library | Angell EYE</title>
