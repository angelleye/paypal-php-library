...
$SECFields = array(
					...
					'returnurl' => $domain . 'demo/express-checkout-3rd-party-no-permissions/GetExpressCheckoutDetails.php', 							    // Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
					'cancelurl' => $domain . 'demo/express-checkout-3rd-party-no-permissions/', 							    // Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
...
$Payment = array(
    ...
    'sellerpaypalaccountid' => $_SESSION["seller"]			// A unique identifier for the merchant.  For parallel payments, this field is required and must contain the Payer ID or the email address of the merchant.
);
