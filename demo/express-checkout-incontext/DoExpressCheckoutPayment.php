...
$Payments = array();
$Payment = array(
    'amt' => number_format($_SESSION['Payment']['grand_total'],2), 	    // Required.  The total cost of the transaction to the customer.  If shipping cost and tax charges are known, include them in this value.  If not, this value should be the current sub-total of the order.
    'itemamt' => number_format($_SESSION['Payment']['amt'],2),       // Subtotal of items only.
    'currencycode' => 'USD', 					                                // A three-character currency code.  Default is USD.
    'shippingamt' => number_format($_SESSION['Payment']['shippingamt'],2), 	// Total shipping costs for this order.  If you specify SHIPPINGAMT you mut also specify a value for ITEMAMT.
    'handlingamt' => number_format($_SESSION['Payment']['handlingamt'],2), 	// Total handling costs for this order.  If you specify HANDLINGAMT you mut also specify a value for ITEMAMT.
    'taxamt' => number_format($_SESSION['Payment']['taxamt'],2), 			// Required if you specify itemized L_TAXAMT fields.  Sum of all tax items in this order.
