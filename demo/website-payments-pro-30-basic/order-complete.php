...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Website Payments Pro 3.0 Basic | Order Complete | PHP Class Library | Angell EYE</title>
            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <p class="bg-info">
                        ...
                        to the Billing Information, which was provided in the ProcessTransaction response.
                    </p>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($_SESSION['shopping_cart']['items'] as $cart_item) {
                                ?>
                                <tr>
                                    <td><?php echo $cart_item['l_number']; ?></td>
                                    <td><?php echo $cart_item['l_name']; ?></td>
                                    <td class="center"> $<?php echo number_format($cart_item['l_amt'], 2); ?></td>
                                    <td class="center"><?php echo $cart_item['l_qty']; ?></td>
                                    <td class="center"> $<?php echo number_format($cart_item['l_qty'] * $cart_item['l_amt'], 2); ?></td>
                                </tr>
                                <?php
                            }
                            ?>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-8 column">
                            ...
                            <p>
                                <?php
                                echo $_SESSION['billing_first_name'] . ' ' . $_SESSION['billing_last_name'] . '<br />' .
                                $_SESSION['billing_email'] . '<br />' .
                                $_SESSION['billing_phone'] . '<br />' .
