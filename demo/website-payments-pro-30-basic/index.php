...
$_SESSION['items'][1] = array(
    ...
    'l_qty' => '2',                             // Item quantity.  Must be any positive integer.  
    'l_taxamt' => '',                       // Item's sales tax amount.
    'l_ebayitemnumber' => '',               // eBay auction number of item.
    'l_ebayitemauctiontxnid' => '',         // eBay transaction ID of purchased item.
    'l_ebayitemorderid' => ''               // eBay order ID for the item.
        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <p class="bg-info">Here we are using a basic shopping cart for display purposes.</p>
                        ...
                        <div class="col-md-4 column">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="center" colspan="2"><a href="checkout.php"><button class="btn btn-primary btn-lg btn-block" type="submit">Proceed to Checkout</button></a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
