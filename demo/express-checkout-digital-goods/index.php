...
<head>
<meta charset="utf-8">
<title>PayPal Express Checkout Digital Goods Demo | PHP Class Library | Angell EYE</title>
              ...
              <tr>
                  <td class="center" colspan="2">
                  	<form action='SetExpressCheckout.php' METHOD='POST'>
                        <input type='image' name='paypal_submit' id='paypal_submit'  src='https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif' border='0' align='top' alt='Pay with PayPal'/>
                    </form>
                  </td>
              </tr>
            </tbody>
